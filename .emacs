...
(setq casey-win32 (not (or casey-linux)))
...
(when casey-win32 
  ...
  ; Setup load-path
  (add-to-list 'load-path "D:/Dropbox/dotfiles/.emacs.d/lisp/")
  (add-to-list 'custom-theme-load-path "D:/Dropbox/dotfiles/.emacs.d/themes/")
)
